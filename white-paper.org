...
#+latex_header: \setmainfont{Poppins}
#+latex_header: \setsansfont{Poppins}
...
#+NAME: fig:formula-01
#+ATTR_LATEX: :width 8.5cm :height 4cm
...
them. As shown in figure, [[fig:reflexiveformula]].
...
#+ATTR_LATEX: :width 8cm :height 3cm
